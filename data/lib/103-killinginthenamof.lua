...
tasks =
{
[1] = {killsRequired = 200, raceName = "Bog Raiders", level = {40, 120}, premium = false, creatures = {"bog raider"}, rewards = {
{type = "exp", value = {50000}},
{type = "money", value = {10000}},
{type = "item", value = {5829,1}},
{type = "storage", value = {35000, 1}}
}},
[2] = {killsRequired = 100, raceName = "Dwarfs", level = {6, 80}, premium = false, creatures = {"dwarf","dwarf soldier","dwarf guard"}, rewards = {
{type = "exp", value = {15000}},
{type = "money", value = {10000}},
{type = "item", value = {2157,2}},
{type = "storage", value = {35001, 1}}
}},
[3] = {killsRequired = 100, raceName = "Undeads", level = {6, 80}, premium = false, creatures = {"ghoul","skeleton"}, rewards = {
{type = "exp", value = {50000}},
{type = "money", value = {5000}},
{type = "item", value = {2157,3}},
{type = "storage", value = {35002, 1}}
}},
[4] = {killsRequired = 100, raceName = "Larvas and Scarabs", level = {8, 80}, premium = false, creatures = {"larva","scarab"}, rewards = {
{type = "exp", value = {50000}},
{type = "money", value = {5000}},
{type = "item", value = {2157,5}},
{type = "storage", value = {35004, 1}}
}},
[5] = {killsRequired = 100, raceName = "Minotaurs", level = {6, 80}, premium = false, creatures = {"minotaur","minotaur guard","minotaur archer","minotaur mage"}, rewards = {
{type = "exp", value = {50000}},
{type = "money", value = {10000}},
{type = "item", value = {2157,2}},
{type = "storage", value = {35005, 1}}
}},
[6] = {killsRequired = 100, raceName = "Rotworms", level = {6, 50}, premium = false, creatures = {"rotworm"}, rewards = {
...
[10] = {killsRequired = 100, raceName = "Ancient Scarabs", level = {40, 120}, premium = false, creatures = {"ancient scarab"}, rewards = {
{type = "exp", value = {150000}},
{type = "money", value = {20000}},
{type = "item", value = {2157,10}},
{type = "storage", value = {35012, 1}}
}},
[11] = {killsRequired = 150, raceName = "Cyclops", level = {8, 100}, premium = false, creatures = {"cyclops"}, rewards = {
{type = "exp", value = {200000}},
{type = "money", value = {20000}},
{type = "item", value = {2157,8}},
{type = "storage", value = {35015, 1}}
}},
[12] = {killsRequired = 100, raceName = "Dragons", level = {30, 200}, premium = false, creatures = {"dragon"}, rewards = {
{type = "exp", value = {150000}},
{type = "money", value = {20000}},
{type = "item", value = {2157,5}},
...
[15] = {killsRequired = 100, raceName = "Heroes", level = {70, 200}, premium = false, creatures = {"hero"}, rewards = {
{type = "exp", value = {200000}},
{type = "money", value = {20000}},
{type = "item", value = {2157,15}},
{type = "storage", value = {35021, 1}}
}},
[16] = {killsRequired = 100, raceName = "Necromancers", level = {20, 150}, premium = false, creatures = {"necromancer"}, rewards = {
{type = "exp", value = {200000}},
...
[17] = {killsRequired = 100, raceName = "Vampires", level = {40, 120}, premium = false, creatures = {"vampire"}, rewards = {
...
[20] = {killsRequired = 100, raceName = "Hydras", level = {40, 180}, premium = false, creatures = {"hydra"}, rewards = {
{type = "exp", value = {250000}},
{type = "money", value = {50000}},
...
[21] = {killsRequired = 100, raceName = "Serpent Spawns", level = {75, 200}, premium = false, creatures = {"serpent spawn"}, rewards = {
{type = "exp", value = {150000}},
{type = "money", value = {30000}},
{type = "item", value = {2157,10}},
{type = "storage", value = {35029, 1}}
}},
[22] = {killsRequired = 100, raceName = "Warlocks", level = {60, 999}, premium = false, creatures = {"warlock"}, rewards = {
...
[24] = {killsRequired = 100, raceName = "Hellfire Fighters", level = {120, 999}, premium = false, creatures = {"hellfire fighter"}, rewards = {
{type = "exp", value = {700000}},
{type = "money", value = {60000}},
{type = "item", value = {2157,10}},
{type = "storage", value = {35039, 1}}
}},
[25] = {killsRequired = 100, raceName = "Undead Dragons", level = {120, 999}, premium = false, creatures = {"undead dragon"}, rewards = {
...
[34] = {killsRequired = 100, raceName = "Goblins", level = {6, 90}, premium = false, creatures = {"goblin"}, rewards = {
{type = "exp", value = {15000}},
